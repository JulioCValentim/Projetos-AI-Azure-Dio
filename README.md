# Projetos-AI-Azure-Dio
Repositório para armazenar projetos da Dio Azure

Olá, seja bem vindo ao meu projeto, a seguir vou listar os procedimentos para criar um laboratorio e a analise que fiz no estúdio do Microsoft Azure.
Fiquem a vontade para dar FeedBacks e lá vamos nós:

Para iniciar o projeto, usei 2 links, que foram disponibilizados no curso, e os compartilhos logo a baixo:

https://microsoftlearning.github.io/mslearn-ai-fundamentals/Instructions/Labs/02-content-safety.html

Esse link a seguir, trata-se do tutorial de como criar um modelo e configurar seu projeto no Azure:

https://microsoftlearning.github.io/mslearn-ai-fundamentals/Instructions/Labs/01-machine-learning.html

Primeiros Passos
-------------------------------------------------------------------------------------------------------
1- Entrar no portal da Microsoft Azure e criar uma conta, acessando este link (https://portal.azure.com), usando suas credenciais da Microsoft,
ou seja, no meu caso usei uma conta de email. Após isso, selecionamos a opção + Create um recurso, e procuramos por Machine Learning, aonde agora podemos criar um novo  recurso da Azure Machine Learning, e iniciamos nosso primeiro projeto.
Durante o processo, temos que usar algumas configurações, logo abaixo estarei disponibilizando para que você possa utilizar:
...
obs.: Quando eu fiz o projeto, preferi criar em inglês, por isso não se assuste se voce encontrar umas palavras diferenciadas kkkkkkk.

https://img.freepik.com/fotos-premium/foto-profissional-de-uma-bela-jovem-em-pose-surpresa-com-rosto-expressivo-e-linguagem-corporal_732449-12479.jpg?w=826
---------------------------------------

2- Após ter configurado, selecionamos Review + Create, e selecionamos Creat, isso irá criar nosso primeiro projeto (ou a metade dele), devemos esperar alguns minutos, para que possa terminar de configurar automaticamente, podemos aproveitar pra comer um lanche, tomar aquela agua (ou cerveja) geladaaaaa :).
Depois de finalizado, podemos ir para a proxima etapa.
------------------------------------------------------------------------------------------------------------------------------------------------
3 - Selecionamos a opção logo abaixo Launch Studio, que abrira em uma nova guia um painel, aonde podemos criar vários conteúdos, como analise de vendas e dados de váriados tipos.
